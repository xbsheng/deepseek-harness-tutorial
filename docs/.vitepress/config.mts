...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      {
        text: 'Example Plugins: Prompt/Shell/FS/Skills',
        link: '/en/08-plugins',
      },
...
export default defineConfig({
  ...
  description:
    '基于最新开源的 deepseek-ai/deepseek-harness,从零到一实现一个包含核心功能的简易版(TS)。',
  ...
  head: [
    [
      ...
      {
        rel: 'icon',
        href: '/deepseek-harness-tutorial/favicon.svg',
        type: 'image/svg+xml',
      },
    ],
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        'https://github.com/xbsheng/deepseek-harness-tutorial/edit/main/docs/:path',
